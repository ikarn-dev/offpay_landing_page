        ...
        <div ref={contentRef} className="cta-card__content" style={{ opacity: 0 }}>
          ...
          <div className="cta-card__text">
            ...
            <div className="cta-card__stores">
              <a href="#waitlist" aria-label="Download on App Store" style={storeBtnStyle}>
                ...
                <span style={{ display: "flex", flexDirection: "column", lineHeight: 1.15 }}>
                  <span style={{ fontSize: "0.55rem", fontWeight: 400, opacity: 0.6 }}>Download on</span>
                  <span>App Store</span>
                </span>
              </a>

              <a href="#waitlist" aria-label="Download on Google Play" style={storeBtnStyle}>
                <svg viewBox="0 0 24 24" fill="currentColor" style={storeIconStyle}>
